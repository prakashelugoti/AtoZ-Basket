...
public class PersonalDummy extends AppCompatActivity {

    GridView gridView;

    static final String[] GRID_DATA = new String[] {"Deodorants & Cosmetics",
            "Feminine Hygiene", "Hair Care","Oral Care","OTC & Wellness",
            "Shaving & Hair Removal","Skin Care","Soaps, Face & Handwash"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_personal_dummy);
        ...
        gridView.setAdapter(new PersonalCustomGridAdapter(this, GRID_DATA));
