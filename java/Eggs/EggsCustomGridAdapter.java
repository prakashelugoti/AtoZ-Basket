package com.user.atozbasket.Eggs;
...
public class EggsCustomGridAdapter extends BaseAdapter {

    private Context context;
    private final String[] gridValues;

    //Constructor to initialize values
    public EggsCustomGridAdapter(Context context, String[] gridValues) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position==0) {
            ...
            imageView.setImageResource(R.drawable.milk_icon);
            //relativeLayout.setBackgroundColor(Color.parseColor("#008D1A"));
            desc.setText("\nFresh milk available for you!");
            ...
            desc.setText("\nFresh chicken, mutton fish etc. available.");

        } else if (position==2) {

            imageView.setImageResource(R.drawable.eggs_icon);
