...
public class BabyDummy extends AppCompatActivity {

    GridView gridView;
Button small_button;
    static final String[] GRID_DATA = new String[] {"Baby Accessories & More",
            "Baby Food", "Baby Skin & Hair Care","Diapers & Wipes"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_baby_dummy);
        ...
        gridView.setAdapter(new BabyCustomGridAdapter(this, GRID_DATA));
