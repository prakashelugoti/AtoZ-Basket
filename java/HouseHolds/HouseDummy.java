...
public class HouseDummy extends AppCompatActivity {

    GridView gridView;

    static final String[] GRID_DATA = new String[] {"Dishwashers & Cleaners",
            "Home & Pooja Needs", "Laundry Detergents","Repellents and Fresheners"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_house_dummy);
        ...
        gridView.setAdapter(new HouseCustomGridAdapter(this, GRID_DATA));
