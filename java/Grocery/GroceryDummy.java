...
public class GroceryDummy extends AppCompatActivity {

    GridView gridView;

    static final String[] GRID_DATA = new String[] {"Dal & Pulses",
            "Dry Fruits", "Edible Oils & Ghee","Masala & Spices","Rice & Rice Products",
    "Sugar & Salt"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grocery_dummy);
        ...
        gridView.setAdapter(new GroCustomGridAdapter(this, GRID_DATA));
