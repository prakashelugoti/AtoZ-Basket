...
public class SMSDelivery extends AppCompatActivity {
EditText editText;
    Button button;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smsdelivery);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String url = "http://api.infoskysolution.com/SendSMS/sendmsg.php?uname=AZBASKET&pass=thisisas&send=AZBSKT&dest="+s+"&msg=Dear customer, your order is delivered successfully. Regards A to Z Basket.";
