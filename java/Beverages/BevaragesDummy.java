...
import com.user.atozbasket.HouseHolds.HouseCustomGridAdapter;
...
public class BevaragesDummy extends AppCompatActivity {

    GridView gridView;

    static final String[] GRID_DATA = new String[] {"Fruit Drinks & Juices",
            "Health & Energy Drinks", "Soft Drinks","Tea & Coffee"};
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bevarages_dummy);
        ...
        gridView.setAdapter(new BeveragesCustomGridAdapter(this, GRID_DATA));
